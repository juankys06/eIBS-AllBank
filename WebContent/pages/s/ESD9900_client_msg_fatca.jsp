<html>
   ...
   %>
          ...
          <tr id="trdark"> 
	            <td nowrap width="30%"> 
    	          <div align="right">Para este Cliente el Formulario a imprimir es el :</div>
           		 ...
           		 <td nowrap width="20%"> 
            	 <input type="text" readonly name="E01TFOR" size="6" maxlength="5" value="<%= ESD990001.getE01TFOR().trim()%>">
    ...
    <%if("S".equals(ESD990001.getE01NOT1())){ %>
	...
	<table class="tableinfo">
  		<tr > 
        	...
        	<table class=tbhead cellspacing="0" cellpadding="2" width="100%"   align="center">
        		<tr>
             	<td nowrap width="10%" align="right"> Apoderado: 
               	</td>
          		<td nowrap width="12%" align="left">
 	...
 	<table class="tableinfo">
    	<tr > 
          ...
          <tr id="trdark"> 
	            <td nowrap width="30%"> 
    	          <div align="right">Para el Apoderado el Formulario a imprimir es el :</div>
 	             </td>
              
           		 <td nowrap width="20%"> 
            	 <input type="text" readonly name="E02TFOR" size="6" maxlength="5" value="<%= ESD990001.getE02TFOR().trim()%>">
