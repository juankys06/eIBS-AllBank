...
var portfolioHelp=31
var custodianHelp=32
...
function getHelp() {
 ...
 switch (optHelp) {
   ...
   case 30 :
      ...
      break;
   case 31 :
      GetPortfolioDescIdInvest(fieldName, fieldAux1, fieldAux2);
      break;
   case 32 :
      GetCustodian(fieldName,fieldAux1);
      break;
...
//   "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0090?SCREEN=7>Mensajes Para el Cajero</A><BR> " +	 
"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD9900?SCREEN=5>Información FATCA</A><BR> "
...
var client_inq_corp_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080?SCREEN=47>Mercadeo</A><BR>" +
//  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0090?SCREEN=9>Mensajes Para el Cajero</A><BR> " +
"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD9900?SCREEN=104&OPECOD=3>Informacion FATCA</A><BR> " + 
...
var client_personal_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080?SCREEN=47>Mercadeo</A><BR> " +
//  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0090?SCREEN=7>Mensajes Para el Cajero</A><BR> " + 
	 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD9900?SCREEN=1>Información FATCA</A><BR> " +
 "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
...
var client_inq_personal_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.tools.JSEDI0010?SCREEN=3&Type=C>Documentación </A><BR> " +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080?SCREEN=47>Mercadeo</A><BR> "  +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD9900?SCREEN=1>Informacion FATCA</A><BR> " + 
//  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0090?SCREEN=9>Mensajes Para el Cajero</A><BR> " +	
  "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
...
// Customer Portfolio Options
 ...
 var cus_port_opt =
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0088?SCREEN=200>Información Básica </A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0089?SCREEN=1>Titulares Portafolio</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010?SCREEN=200&OPCODE=0002>Perfil de Inversiones</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010?SCREEN=3>Cuentas de Caja</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080?SCREEN=33>Direccion de Correo</A><BR>" +
// "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010?SCREEN=52>Lavado de Dinero</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";

var cus_i_port_opt =
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0088?SCREEN=500>Información Basica</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0089?SCREEN=1>Titulares Portafolio</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010I?SCREEN=200>Perfil de Inversiones</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010I?SCREEN=3>Cuentas de Caja</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080?SCREEN=33>Direccion de Correo</A><BR>" +
 // "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010I?SCREEN=52>Lavado de Dinero</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Exit</A>";

var cus_a_port_opt =
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0088?SCREEN=501>Información Basica</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0089?SCREEN=1>Titulares Portafolio</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010A?SCREEN=200>Perfil de Inversiones</A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080A?SCREEN=33>Direccion de Correo</A><BR>" +
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010A?SCREEN=3>Cuentas de Caja</A><BR>"+
// "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010A?SCREEN=52>Lavado de Dinero</A><BR>"+
...
var cd_m_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXEDL0130?SCREEN=21>Códigos de Clasificacion</A><BR>" +
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0130?SCREEN=55>Firmantes</A><BR>" +
...
var cd_i_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXEDL0130I?SCREEN=27>Códigos de Clasificacion</A><BR>" +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXEDL0130I?SCREEN=29>Titulares</A><BR>"  +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0130I?SCREEN=55>Firmantes</A><BR>" +
...
//  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXEDD0000?SCREEN=19&COUNTRY=PA&H04SCR=07>Firmantes</A><BR> " +
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXEDD0000?SCREEN=13>Codigos de Clasificacion </A><BR> " +
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.reports.JSEFRM000?SCREEN=1&OPE_CODE=01>Formularios</A><BR>" +
  "<A HREF= javascript:getPdfForms('<%=request.getContextPath()%>/pages/s/EFRM000_pdf_form.jsp?SCREEN=1&OPE_CODE=01')>Formularios (PDF)</A><BR>" +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0090?SCREEN=1>Mensajes Para el Cajero</A><BR> " +	 
  "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
...
var rt_i_opt_f =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD5500I?SCREEN=19&opt=INQ>Firmantes </A><BR> " +
  "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
...
"<A HREF=<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSECIF040?SCREEN=1>Promedios</A><BR>" +
//"<A HREF=<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0000I?SCREEN=36&COUNTRY=PA&H04SCR=07>Firmantes </A><BR> " +
"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD5500I?SCREEN=19&opt=INQ>Firmantes </A><BR> " +
"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0000F?SCREEN=1&Type=FI&PURPOSE=R>Reglas de Firmas </A><BR> " +
"<A HREF=<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0000I?SCREEN=35>Codigos de Clasificacion </A><BR> " +
...
"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD1205?SCREEN=600>Restricciones</A><BR> " +
"<A HREF=<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0090?SCREEN=3>Mensajes Para el Cajero</A><BR> " +	
"<A HREF=<%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
...
var ln_m_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXEDL0150?SCREEN=15>Códigos de Clasificacion</A><BR>" +
...
var ln_i_1_opt  =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXEDL0160?SCREEN=3>Códigos de Clasificacion</A><BR>" +
...
var pc_optionHeader =
  ...
  "<A HREF= javascript:callDocs();>Recaudos</A><BR>" +
  "<A HREF= \"javascript:callSegP();\">Seguimiento Propuesta</A><BR>" +
  "<A HREF= \"javascript:callImpP();\">Imprimir Propuesta</A><BR>" +
...
var cc_m_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECC0010?SCREEN=7>Códigos de Clasificacion</A><BR>"+
...
var cc_i_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECC0010I?SCREEN=7>Códigos de Clasificacion</A><BR>"+
...
var lc_opening =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0500?SCREEN=101>Códigos de Clasificacion</A><BR>"+
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0500?SCREEN=50&CODE=999>Bit&aacute;cora / Notas</A><BR>"+  
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.trade.JSELC0500A?SCREEN=3>Informaci&oacute;n Adicional</A><BR>"+
  "<A HREF=<%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
...
var sb_opening =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0400?SCREEN=101>Códigos de Clasificacion</A><BR>"+
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.reports.JSEFRM000?SCREEN=1&OPE_CODE=01>Formularios</A><BR>" +
  "<A HREF= javascript:getPdfForms('<%=request.getContextPath()%>/pages/s/EFRM000_pdf_form.jsp?SCREEN=1&OPE_CODE=01')>Formularios (PDF)</A><BR>" +
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0400?SCREEN=50&CODE=999>Bit&aacute;cora / Notas</A><BR>"+      
  "<A HREF=<%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
...
var lc_approbal_detail =
  ...
  "<A HREF= javascript:goDetail('101');>Códigos de Clasificacion</A><BR>"+
 ...
 var lc_maint_detail =
  ...
  "<A HREF= javascript:goDetail('20101');>Códigos de Clasificacion</A><BR>"+
...
// LETTER OF CREDIT APPROVAL
		...
		"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0525?SCREEN=5006&fcode=ELC0500>Códigos de Clasificacion</A><BR>"+
		...
		"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0525?SCREEN=1>Aprobar</A><BR>"+
		"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0525?SCREEN=2>Eliminar</A><BR>"+
		"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0525?SCREEN=5009>Ver Transacciones</A><BR>"+		
		"<A HREF= javascript:void(CenterWindow('<%=request.getContextPath()%>/servlet/datapro.eibs.approval.JSEPR1080A?SCREEN=8',450,350,2)) >Mensaje SWIFT</A><BR>"+
		"<A HREF=<%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
		...
		"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0525?SCREEN=5106&fcode=ELC0510>Códigos de Clasificacion</A><BR>"+
		...
		"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0525?SCREEN=4006&fcode=ELC0400>Códigos de Clasificacion</A><BR>"+
...
var lc_maint =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0510?SCREEN=201>Códigos de Clasificacion</A><BR>"+
...
var dc_d_maint =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDC0000?SCREEN=7>Códigos de Clasificacion</A><BR>"+
...
var dc_s_maint =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDC0010?SCREEN=7>Códigos de Clasificacion</A><BR>"+
...
var dc_d_inquiry =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.approval.JSEDC0040?SCREEN=7>Códigos de Clasificacion</A><BR>"+
...
var cl_a_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.credit.JSELN0000A?SCREEN=21>Códigos de Clasificacion</A><BR>" +
...
var cd_a_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0130A?SCREEN=21>Códigos de Clasificacion</A> <BR>" +
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0130A?SCREEN=55>Firmantes</A><BR>" +
...
var ln_a_opt =
 	...
 	"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEXEDL0160?SCREEN=12>Garantías Asignadas</A><BR>" +
	"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0150A?SCREEN=15>Códigos de Clasificacion</A><BR>" +
...
var cc_a_opt =
	...
	"<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSECC0010A?SCREEN=7>Códigos de Clasificacion</A><BR>" +
...
//  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0000A?SCREEN=19&H04SCR=07>Firmantes</A><BR> " +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD5500A?SCREEN=19>Firmantes </A><BR> " +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0000F?SCREEN=1&Type=FI&PURPOSE=I>Reglas de Firmas </A><BR> " +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0000A?SCREEN=13>Codigos de Clasificacion</A><BR> " +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD1205?SCREEN=600>Restricciones</A><BR> " +
  ...
  "<A HREF= \"javascript:goOpenerAction('R')\" >Rechazar</A><BR>" +
  "<hr align=\"center\" style=\"height:1pt;color:navy\">"+
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0090?SCREEN=5>Mensajes Para el Cajero</A><BR> " +        
  "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
...
var client_ap_corp_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080A?SCREEN=47>Mercadeo</A><BR>" +
   "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD9900?SCREEN=104&OPECOD=1>Informacion FATCA</A><BR> " + 
  "<hr align=\"center\" style=\"height:1pt;color:navy\">"+
  "<A HREF= \"javascript:goOpenerAction('A')\" >Aprobar</A><BR>" +
  "<A HREF= \"javascript:goOpenerAction('R')\" >Rechazar</A><BR>" +
  "<hr align=\"center\" style=\"height:1pt;color:navy\">"+
//  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSESD0090?SCREEN=11>Mensajes Para el Cajero</A><BR> " +	
  "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";
...
var client_ap_personal_opt =
  ...
  "<A HREF= javascript:getPdfForms('<%=request.getContextPath()%>/pages/s/EFRM000_pdf_form.jsp?SCREEN=1&OPE_CODE=01&APP_CODE=00')>Formularios (PDF)</A><BR>" +
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080A?SCREEN=47>Mercadeo</A><BR> "  +
   "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD9900?SCREEN=4>Información FATCA</A><BR> " +
  "<hr align=\"center\" style=\"height:1pt;color:navy\">"+
  "<A HREF= \"javascript:goOpenerAction('A')\" >Aprobar</A><BR>" +
  "<A HREF= \"javascript:goOpenerAction('R')\" >Rechazar</A><BR>" +
  "<hr align=\"center\" style=\"height:1pt;color:navy\">"+
...
var colla_A_opt =
 ...
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.client.JSERA0100?SCREEN=11>Historia de Avalúos</A><BR>"+
 "<hr align=\"center\" style=\"height:1pt;color:navy\">"+
 "<A HREF= \"javascript:goOpenerAction('A')\" >Aprobar</A><BR>" +
 "<A HREF= \"javascript:goOpenerAction('R')\" >Rechazar</A><BR>" +
 "<hr align=\"center\" style=\"height:1pt;color:navy\">"+
...
var of_p_opt =
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEOF0115?SCREEN=1>Información Basica</A><BR>"+
...
var of_np_opt =
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEOF0115?SCREEN=1&RD=1>Informacion Basica</A><BR>"+
...
var dft_m_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0800?SCREEN=15>Códigos de Clasificacion</A><BR>" +
...
var dft_i_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0800?SCREEN=31>Códigos de Clasificacion</A><BR>" +
...
var dft_a_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDL0800?SCREEN=35>Códigos de Clasificacion</A><BR>" +
...
var cd_bo_opt =
 ...
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130B?SCREEN=61>Códigos de Clasificacion</A><BR>" +
...
var cd_bo_act_opt =
 ...
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130B?SCREEN=63>Renovación</A><BR>" +
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130B?SCREEN=65>Lavado de Dinero</A><BR>" +
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130B?SCREEN=61>Codigos de Clasificacion</A><BR>" +
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130B?SCREEN=51>Titulares</A><BR> "  +
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130B?SCREEN=57>Beneficiarios</A><BR>" +
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130B?SCREEN=55>Instrucciones Especiales</A><BR>" +
 "<hr align=\"center\" style=\"height:1pt;color:navy\">"+
...
var cdm_m_opt =
     ...
     "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130M?SCREEN=21>Códigos de Clasificacion</A><BR>" +
...
var cdt_i_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0130IT?SCREEN=27>Códigos de Clasificacion</A><BR>" +
...
var inst_basic_opt =
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0050?SCREEN=400>Informacion Basica </A><BR>"+
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0060?SCREEN=4>Cuotas</A><BR>"+
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0070?SCREEN=900>Plan de Pagos</A><BR>" +
  "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";

var inst_inq_opt =
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0050?SCREEN=800>Información Básica</A><BR>"+
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0060I?SCREEN=4>Cuotas</A><BR>"+
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0070I?SCREEN=900>Plan de Pagos</A><BR>" +
  "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";

var inst_app_opt =
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0050?SCREEN=1000>Información Básica</A><BR>"+
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0060A?SCREEN=4>Cuotas</A><BR>"+
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0070A?SCREEN=900>Plan de Pagos</A><BR>" +
	"<hr align=\"center\" style=\"height:1pt;color:navy\">"+
	"<A HREF= \"javascript:appPrint();\" >Imprimir</A><BR>" +
  	"<A HREF= \"javascript:goOpenerAction('A')\" >Aprobar</A><BR>" +
  	"<A HREF= \"javascript:goOpenerAction('R')\" >Rechazar</A><BR>" +
...
var trade_a_ticket_opt =
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0130A?SCREEN=400>Información Básica </A><BR>"+
	"<hr align=\"center\" style=\"height:1pt;color:navy\">"+
	"<A HREF= \"javascript:appPrint();\" >Imprimir</A><BR>" +
  	"<A HREF= \"javascript:goOpenerAction('A')\" >Aprobar</A><BR>" +
  	"<A HREF= \"javascript:goOpenerAction('R')\" >Rechazar</A><BR>" +
 ...
 var inv_port_opt =
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010?SCREEN=1>Portafolio </A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010?SCREEN=3>Cuentas Transaccionales</A><BR>"+

 "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";

var inv_i_port_opt =
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010I?SCREEN=1>Portafolio </A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010I?SCREEN=3>Cuentas Transaccionales</A><BR>"+

 "<A HREF= <%=request.getContextPath()%>/pages/background.jsp>Salir</A>";

var inv_a_port_opt =
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010A?SCREEN=1>Portafolio </A><BR>"+
 "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.invest.JSEIE0010A?SCREEN=3>Cuentas Transaccionales</A><BR>"+
 	"<hr align=\"center\" style=\"height:1pt;color:navy\">"+
	"<A HREF= \"javascript:appPrint();\" >Imprimir</A><BR>" +
  	"<A HREF= \"javascript:goOpenerAction('A')\" >Aprobar</A><BR>" +
  	"<A HREF= \"javascript:goOpenerAction('R')\" >Rechazar</A><BR>" +
...
var cl_m_opt =
  ...
  "<A HREF= <%=request.getContextPath()%>/servlet/datapro.eibs.credit.JSELN0000?SCREEN=21>Códigos de Clasificacion</A><BR>" +
